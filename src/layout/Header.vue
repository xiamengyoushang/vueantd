    ...
    <a-dropdown>
      <a-button class="avatar-btn" type="link">
        <div class="avatar-btn-main">
          ...
          <div class="avatar-btn-username">{{ details.account }}</div>
        </div>
      </a-button>
      <a-menu slot="overlay">
        <a-menu-item>
          <router-link to="/account">
            <a-icon class="icon" type="smile"/>我的账户
          </router-link>
        </a-menu-item>
        <a-menu-item>
          <router-link to="/role">
            <a-icon class="icon" type="setting"/>权限设置
          </router-link>
        </a-menu-item>
        <a-menu-divider/>
        <a-menu-item @click="handleLogout">
          <a-icon class="icon" type="logout"/>退出登录
        </a-menu-item>
      </a-menu>
    </a-dropdown>
...
export default {
  ...
  created() {
      this.details.account = this.$store.getters.getUser.account;
  },
  methods: {
